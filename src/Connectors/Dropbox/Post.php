...
class Post extends Dropbox
{
    ...
    public function send($component, $text = 'Hello word')
    {
        try {
            ...
            // valid on Dropbox (that it fits all requirements), is the following:
            ...
            $photo = new \DropboxAPI\Media\Photo\DropboxPhoto($component->getTarget());
