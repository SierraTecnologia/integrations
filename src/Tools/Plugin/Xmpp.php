...
use Finder\Models\Infra\Ci\Build;
use Integrations\Tools\Plugin;

/**
 * Xampp Notification - Send notification for successful or failure build
 *
 * @author Alexandre Russo <dev.github@ange7.com>
 */
class Xampp extends Plugin
{
    ...
    public function execute()
    {
        ...
        /*
         * Send Xampp notification for all recipients
         */
