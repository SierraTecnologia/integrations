...
use Integrations\Tools\Programs\Git\Reference\Branch;
use Integrations\Tools\Programs\Git\Reference\Stash;
use Integrations\Tools\Programs\Git\Reference\Tag;
...
class ReferenceBag implements \Countable, \IteratorAggregate
{
     ...
     * Constructor.
     *
     * @param Integrations\Tools\Programs\Git\Repository $repository The repository
     */
    ...
    public function createBranch($name, $commitHash): Reference
    {
    ...
    public function createTag($name, $commitHash): Reference
    {
    ...
    public function hasBranch($name): bool
    {
        return $this->has('refs/heads/'.$name);
    }

    public function hasRemoteBranch($name): bool
    {
     ...
     * @param self $hash
     */
    public function resolve(self $hash)
    {
        $this->initialize();
     ...
     * @return Branch
     */
    public function getRemoteBranch(string $name)
    {
        $this->initialize();
