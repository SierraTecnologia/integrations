    ...
    <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
                    <div class="box-header panel-header card-header with-border">
                        ...
                        <h3 class="box-title panel-title card-title">Collaborator</h3>
                      </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
                        <div class="box-header panel-header card-header with-border">
                            ...
                            <h3 class="box-title panel-title card-title">collaborator_info</h3>
                      </div>
                      <!-- /.box-header panel-header card-header -->
                      <div class="box-body panel-body card-body">
                        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
    <div class="box-header panel-header card-header with-border">
        ...
        <h3 class="box-title panel-title card-title">Order Origin</h3>
      </div>
      <!-- /.box-header panel-header card-header -->
      <div class="box-body panel-body card-body">
        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
    <div class="box-header panel-header card-header with-border">
        ...
        <h3 class="box-title panel-title card-title">novacao_type_id</h3>
      </div>
      <!-- /.box-header panel-header card-header -->
      <div class="box-body panel-body card-body">
        <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
    <div class="box-header panel-header card-header with-border">
        ...
        <h3 class="box-title panel-title card-title">operadora</h3>
      </div>
      <!-- /.box-header panel-header card-header -->
      <div class="box-body panel-body card-body">
        <blockquote>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
        <div class="box-header panel-header card-header with-border">
            ...
            <h3 class="box-title panel-title card-title">operadora_mundipagg_public</h3>
          </div>
          <!-- /.box-header panel-header card-header -->
          <div class="box-body panel-body card-body">
            <blockquote>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
                  <div class="box-header panel-header card-header with-border">
                      ...
                      <h3 class="box-title panel-title card-title">operadora_mundipagg_secret</h3>
                    </div>
                    <!-- /.box-header panel-header card-header -->
                    <div class="box-body panel-body card-body">
                      <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
    <div class="box-header panel-header card-header with-border">
        ...
        <h3 class="box-title panel-title card-title">operadora_pagseguro_public</h3>
      </div>
      <!-- /.box-header panel-header card-header -->
      <div class="box-body panel-body card-body">
        <blockquote>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
              <div class="box-header panel-header card-header with-border">
                  ...
                  <h3 class="box-title panel-title card-title">operadora_pagseguro_secret</h3>
                </div>
                <!-- /.box-header panel-header card-header -->
                <div class="box-body panel-body card-body">
                  <blockquote>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
              <div class="box-header panel-header card-header with-border">
                  ...
                  <h3 class="box-title panel-title card-title">operadora_rede_public</h3>
                </div>
                <!-- /.box-header panel-header card-header -->
                <div class="box-body panel-body card-body">
                  <blockquote>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
                        <div class="box-header panel-header card-header with-border">
                            ...
                            <h3 class="box-title panel-title card-title">operadora_rede_secret</h3>
                          </div>
                          <!-- /.box-header panel-header card-header -->
                          <div class="box-body panel-body card-body">
                            <blockquote>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
                        <div class="box-header panel-header card-header with-border">
                            ...
                            <h3 class="box-title panel-title card-title">operadora_cielo_public</h3>
                          </div>
                          <!-- /.box-header panel-header card-header -->
                          <div class="box-body panel-body card-body">
                            <blockquote>
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
                                  <div class="box-header panel-header card-header with-border">
                                      ...
                                      <h3 class="box-title panel-title card-title">operadora_cielo_secret</h3>
                                    </div>
                                    <!-- /.box-header panel-header card-header -->
                                    <div class="box-body panel-body card-body">
                                      <blockquote>
...
<div class="col-xs-12 col-sm-12 col-md-12"><div class="box panel card box-solid">
    <div class="box-header panel-header card-header with-border">
        ...
        <h3 class="box-title panel-title card-title">Novação Seguros Token</h3>
      </div>
      <!-- /.box-header panel-header card-header -->
      <div class="box-body panel-body card-body">
        <blockquote>
